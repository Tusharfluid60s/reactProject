...
const Home = () => {
  return (
    <Box>
      <MyCarousel />
      {/* <Container minH={'100vh'} bgColor={'red'}>afdfa</Container>  in cakra ui width and height is defalut in small so we use maxW and minH */}
      ...
      <Container maxW={'container.xl'} minH={'100vh'} p="16">
        ...
        <Stack
          ...
          // phone m h to coloumn varna row 
        >
          <Image src={img5} h={['40', '400']} filter={'hue-rotate(-130deg)'} />
          {/* we pass an array in which height is in small screen is 40 and in big screen is 400  */}
 
          <Text
            letterSpacing={'2px'}
            lineHeight={'190%'}
            p={['4', '16']}// same here in phone p is 4 and in computer 16
            textAlign={'center'}
          >
